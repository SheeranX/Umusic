...
$(function(){
	...
	$("#collect").click(function () {
	    ...
	    var heart = $(".heart");
	    var flyElm = heart.clone().css('opacity', 0.75);
	    if ($("#_username").is(":empty")) {
	        ...
	        $.ajax({
	            type: 'POST',
	            dataType:'text',
	            url: '/Function/AjaxCollection?id=' + $("#_number").text(),
	            ...
	            success: function (data) {
	                if ("true" == data)
	                {
	                    ...
	                    flyElm.css({
	                        ...
	                        'display': 'block',
	                        'position': 'absolute',
	                        'top': heart.offset().top + 'px',
	                        'left': heart.offset().left + 'px',
	                        'width': heart.width() + 'px',
	                        'height': heart.height() + 'px',
	                        'color': '#d9534f'
	                    });
	                    flyElm.animate({
	                        top: $('#minus').offset().top,
	                        left: $('#minus').offset().left + 20,
	...
	$("#fbtnsubmit").click(function () {
	    var fdata = "{\"username\":\"" + $("#fusername").val() + "\",\"email\":\"" + $("#femail").val() + "\",\"phone\":\"" + $("#fphone").val() + "\"}";
	    $.ajax({
	        type: "post",
	        dataType: "text",
	        url: "/Function/fpwd",
	...
	$("#conusername").blur(function () {
	    $.ajax({
	        type: "post",
	        dataType: "text",
	        url: "/Function/valContact?username=" + $(this).val(),
	        beforeSend: function () {
